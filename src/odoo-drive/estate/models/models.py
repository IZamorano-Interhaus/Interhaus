...
from odoo.odoo import _, _lt, api, fields, models
from odoo.odoo.osv.expression import AND, TRUE_DOMAIN, normalize_domain
from odoo.odoo.tools import date_utils, lazy
from odoo.odoo.tools.misc import get_lang
