...
class OrdenCompra(models.Model):
    ...
    x_studio_cuenta_contable=fields.Many2one('account.account',
                                             compute="_get_cuenta_contable"
                                             )
    name=fields.Text(
        string='N°OC',
        required=True,
    ...
    x_studio_many2one_field_w1OXM=fields.Many2one(
        'account.analytic.account'#, 
        #compute="_get_centro_negocio"
        )
